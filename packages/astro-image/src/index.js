    ...
    hooks: {
      'astro:config:setup': async ({
        ...
        const { default: defaultLoader } =
          await (resolvedOptions.serviceEntryPoint === '@astrojs/image/sharp'
            ? import('./loaders/sharp.js')
            : import('./loaders/squoosh.js'));
      ...
      'astro:build:generated': async ({ dir }) => {
        var _a;
        const loader =
          (_a = globalThis == null ? void 0 : globalThis.astroImage) == null
            ? void 0
            : _a.loader;
...
export { integration as default, getImage, getPicture };
